...
if(isset($_POST['user_update'])){
    ...
    if($result_query){
        ...
        echo "<script>window.location.href = 'http://localhost/adoptpets/users_area/logout.php';</script>";
    }
}
...
<body>
   ...
   <form action="" method="post" enctype="multipart/form-data" >
    ...
    <div class="form-outline mb-4 d-flex w-50 m-auto">
        ...
        <img src="../users_area/user_images/<?php echo $user_image?>" alt="" class="edit_image" >
    </div>
    <div class="form-outline mb-4">
